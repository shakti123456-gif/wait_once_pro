...
SECRET_KEY = 'django-insecure-+d0@2#pxeuq6eh%*2$axfu1@q%m_bt+yjs+vv5t=0rfrg&1u!w'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['wait-once.azurewebsites.net','127.0.0.1','localhost']
...
# hostname=medical.mysql.database.azure.com
# hostname=""
# username=wait_once
